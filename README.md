...
This is the seed project for the Reduce Redux Boilerplate Course on egghead.io. For the step by step branches, please see the [egghead_redux_actions_course repo](https://github.com/avanslaars/egghead_redux_actions_course).
